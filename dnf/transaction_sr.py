...
class TransactionFileError(dnf.exceptions.Error):
    def __init__(self, filename, errors):
        ...
        if filename:
            msg = _('The following problems occurred while creating a transaction from file "{filename}":').format(filename=filename)
        else:
            msg = _('The following problems occurred while creating a transaction:')
